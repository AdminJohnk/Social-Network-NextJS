  ...
  return (
    <div className='search'>
      <div className='top px-5'>
        ...
        <form action=''>
          <div className='flex-start bg-hover-1 rounded-lg'>
            ...
            <input
              ...
              id='name'
              className={cn(
                'bg-transparent !ring-transparent border-none text-text-1 w-full'
              )}
              placeholder='Search'
      ...
      <div className='bottom'>
        <div className='mb-5 px-5 flex-between'>
          ...
          <span className='base-semibold text-primary-500 cursor-pointer'>
            Clear all
          </span>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className='ps-3'>
                    ...
                    <div className='small-regular text-text-3'>
                      {item.feature}
                    </div>
                  </div>
                </div>
