        ...
        <div className="right w-full h-full absolute top-0 right-0 z-10 hidden transition-transform">
            <div className="w-[360px] border-l shadow-lg h-screen bg-white absolute right-0 top-0 uk-animation-slide-right-medium delay-200 z-50 dark:bg-background-2 dark:border-slate-700">
                ...
                <div className="py-10 text-center text-sm pt-20">
                    ...
                    <div className="mt-5">
                        <Link href="profile.html" className="inline-block rounded-full px-4 py-1.5 text-sm font-semibold bg-hover-1">View profile</Link>
                    </div>
                </div>
                ...
                {/* <!-- close button --> */}
                <button type="button" className="absolute top-0 right-0 m-4 p-2 hover:bg-hover-1 rounded-full" data-uk-toggle="target: .right ; cls: hidden">
            ...
            {/* <!-- overly --> */}
            <div className="bg-slate-100/40 backdrop-blur absolute w-full h-full dark:bg-slate-800/40" data-uk-toggle="target: .right ; cls: hidden"></div>
