  ...
  return (
    <div className="bg-foreground-1 rounded-lg shadow-sm p-5 px-6">
      ...
      <ul className="text-gray-700 space-y-4 mt-2 mb-1 text-sm dark:text-white">
        <li> This group, it's not a group of Dr. Adan Adam, and she don't know about it , it's a group for people.</li>
        ...
        <li className="flex items-center gap-3">
          ...
          <div>  Members <span className="font-semibold text-text-1"> 3,240 People </span> </div>
        </li>
      </ul>
    </div>
  );
