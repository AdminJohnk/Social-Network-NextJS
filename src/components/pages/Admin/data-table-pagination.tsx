      ...
      <div className='flex items-center space-x-6 lg:space-x-8'>
        <div className='flex items-center space-x-2'>
          ...
          <Select
            ...
            onValueChange={(value) =>
              setPagination((pre) => ({ ...pre, pageSize: Number(value), pageIndex: 0 }))
            }>
        ...
        <div className='flex items-center space-x-2'>
          <Button
            ...
            onClick={() => setPagination((pre) => ({ ...pre, pageIndex: 0 }))}
          ...
          <Button
            ...
            onClick={() => setPagination((pre) => ({ ...pre, pageIndex: pre.pageIndex - 1 }))}
            disabled={!table.getCanPreviousPage()}>
          ...
          <Button
            variant='outline'
            className='hidden h-8 w-8 p-0 lg:flex'
            onClick={() => setPagination((pre) => ({ ...pre, pageIndex: table.getPageCount() - 1 }))}
            disabled={!table.getCanNextPage()}>
