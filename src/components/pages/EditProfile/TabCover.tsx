        ...
        <>
          ...
          <Tabs id='setting_tab' disableChevron active={tab}>
            <TabTitle
              onClick={() => {
                router.push(
                  pathname + '?' + createQueryString('tab', 'general')
                );
              }}
            >
              {t('General')}
            ...
            <TabTitle
              onClick={() => {
                router.push(
                  pathname + '?' + createQueryString('tab', 'social-links')
                );
              }}
            >
              {t('Social links')}
            ...
            <TabTitle
              onClick={() => {
                router.push(
                  pathname + '?' + createQueryString('tab', 'expertise')
                );
              }}
            >
              {t('Expertise')}
            ...
            <TabTitle
              onClick={() => {
                router.push(
                  pathname + '?' + createQueryString('tab', 'experience')
                );
              }}
            >
              {t('Experience')}
            ...
            <TabTitle
              onClick={() => {
                router.push(
                  pathname + '?' + createQueryString('tab', 'repository')
                );
              }}
            >
              {t('Repository')}
            ...
            <TabTitle
              onClick={() => {
                router.push(
                  pathname + '?' + createQueryString('tab', 'password')
                );
              }}
            >
              {t('Password')}
