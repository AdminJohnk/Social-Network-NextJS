      ...
      <div className='flex'>
        ...
        <div className='grow'>
          <div>
            ...
            /authorize endpoint through the third argument of signIn(). They
            show two examples: However, there is no full working example and Im
            unable to read any additional parameters that Ive added in
            /api/auth/[...nextauth].js. Can anyone show me how to read these
            additional parameters in, for example, the signIn() callback? Heres
