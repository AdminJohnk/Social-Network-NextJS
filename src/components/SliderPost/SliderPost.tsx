        ...
        <div className="mt-8">
            ...
            <div className="relative mt-5" tabIndex={-1} data-uk-slider="autoplay: true;finite: true">
                ...
                <div className="overflow-hidden uk-slider-container py-10">
                    ...
                    <ul className="-ml-2 uk-slider-items w-[calc(100%+0.875rem)]" data-uk-scrollspy="target: > li; cls: uk-animation-slide-right-small; delay: 50" data-uk-lightbox="">
                        <li className="lg:w-1/5 sm:w-1/4 w-1/3 pr-3.5 max-lg:hidden" data-uk-scrollspy-class="uk-animation-fade">
                ...
                <button type="button" className="absolute -translate-y-1/2 bg-hover-1 rounded-full top-1/2 -left-4 grid w-9 h-9 place-items-center shadow  dark:bg-dark3" data-uk-slider-item="previous"> <IoChevronBack className="text-2xl" /> </button>
                <button type="button" className="absolute -right-4 -translate-y-1/2 bg-hover-1 rounded-full top-1/2 grid w-9 h-9 place-items-center shadow  dark:bg-dark3" data-uk-slider-item="next"> <IoChevronForward className="text-2xl" /> </button>
