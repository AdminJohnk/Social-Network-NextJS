...
export default function PostSkeleton(props: IPostSkeletonProps) {
  return (
    <div className='post-skeleton bg-foreground-1 rounded-lg p-4'>
      ...
      <Skeleton
        className='bg-hover-1 mt-5 w-full rounded-lg'
        variant='rectangular'
        height={200}
      />
      <div className='flex-between mt-4'>
        <div className='flex-start'>
          <Skeleton
            className='bg-hover-1 w-16 me-3'
            variant='text'
            sx={{ fontSize: '1.5rem' }}
          />{' '}
          <Skeleton
            className='bg-hover-1 w-16'
            variant='text'
            sx={{ fontSize: '1.5rem' }}
          />
        </div>
