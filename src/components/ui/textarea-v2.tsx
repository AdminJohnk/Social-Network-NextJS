  ...
  return (
    <div className='relative w-full min-w-[200px]'>
      <textarea
        ...
        maxLength={maxLength}
        className={cn(
          'peer w-full resize-none border-gray-200 focus:border-violet-500 border-[0] border-b bg-transparent pt-4 pb-1.5 px-0 mt-4 font-sans text-[1rem] font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:outline-0 disabled:resize-none disabled:border-0 disabled:bg-blue-gray-50 !ring-transparent !shadow-none !outline-none custom-scrollbar-bg',
          className
        )}
        placeholder=''
        onChange={e => {
