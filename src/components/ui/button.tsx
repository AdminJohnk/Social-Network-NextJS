...
const buttonVariants = cva(
  'duration-500 inline-flex items-center justify-center rounded-lg text-sm font-medium disabled:pointer-events-none disabled:opacity-50 !outline-none !ring-transparent !border-none',
  {
    variants: {
      variant: {
        default:
          'text-text-1 bg-primary-700 hover:bg-primary-800 dark:bg-primary-600 dark:hover:bg-primary-700',
        destructive: 'text-text-1 bg-red-600 hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600',
