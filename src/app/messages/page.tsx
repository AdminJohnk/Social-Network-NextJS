...
import { IoAddCircleOutline, IoCheckmarkCircleOutline, IoCheckmarkOutline, IoChevronBackOutline, IoChevronDownOutline, IoClose, IoDocumentText, IoFlagOutline, IoHappyOutline, IoHeartOutline, IoImage, IoImages, IoNotificationsOffOutline, IoNotificationsOutline, IoSendOutline, IoSettingsOutline, IoStopCircleOutline, IoTrashOutline, IoVolumeMuteOutline } from 'react-icons/io5';
                    ...
                    <div className="2xl:max-w-6xl mx-auto h-screen relative shadow-lg overflow-hidden border1 max-md:pt-14">
                        ...
                        <div className="flex bg-white dark:bg-background-2">
                            ...
                            <div className="md:w-[360px] relative border-r dark:border-slate-700">
                                    ...
                                    <div className="p-4 border-b dark:border-slate-700">
                                        ...
                                        <div className="flex mt-2 items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-2.5">
                                                ...
                                                <div className="md:w-[270px] w-full" data-uk-dropdown="pos: bottom-left; offset:10; animation: uk-animation-slide-bottom-small">
                                                    <nav>
                                                        <Link href="#" className='hover:!bg-hover-1'> <IoCheckmarkOutline className="text-2xl shrink-0 -ml-1" /> Mark all as read </Link>
                                                        <Link href="#" className='hover:!bg-hover-1'> <IoNotificationsOutline className="text-2xl shrink-0 -ml-1" /> notifications setting </Link>
                                                        <Link href="#" className='hover:!bg-hover-1'> <IoVolumeMuteOutline className="text-2xl shrink-0 -ml-1" /> Mute notifications </Link>
                                                    </nav>
                                                </div>
                                                ...
                                                {/* <!-- mobile toggle menu --> */}
                                                <button type="button" className="md:hidden" data-uk-toggle="target: #side-chat ; cls: max-md:-translate-x-full">
                                        ...
                                        <div className="relative mt-4">
                                            <div className="absolute left-3 bottom-1/2 translate-y-1/2 flex"><FaSearch className="text-xl" /> </div>
                                ...
                                {/* <!-- overly --> */}
                                <div id="side-chat" className="bg-slate-100/40 backdrop-blur w-full h-full dark:bg-slate-800/40 z-40 fixed inset-0 max-md:-translate-x-full md:hidden" data-uk-toggle="target: #side-chat ; cls: max-md:-translate-x-full"></div>
                                ...
                                <div className="w-full p-5 py-10 overflow-y-auto md:h-[calc(100vh-137px)] h-[calc(100vh-250px)] custom-scrollbar-fg">
                                    ...
                                    <div className="py-10 text-center text-sm lg:pt-8">
                                        ...
                                        <div className="mt-3.5">
                                            <Link href="profile.html" className="inline-block rounded-lg px-4 py-1.5 text-sm font-semibold bg-hover-1">View profile</Link>
                                        </div>
                                    </div>
