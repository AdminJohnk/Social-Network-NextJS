        ...
        <main className='ms-60 max-lg:ms-0'>
            ...
            <div className="2xl:max-w-[1220px] max-w-[1065px] mx-auto">
                ...
                <div className="relative" tabIndex={-1} data-uk-slider="finite:true">
                    ...
                    {/* <!-- slide nav icons --> */}
                    <Link className="nav-prev !top-20" href="#" data-uk-slider-item="previous"> <IoChevronBack className="text-2xl" />  </Link>
                    <Link className="nav-next !top-20" href="#" data-uk-slider-item="next"> <IoChevronForward className="text-2xl" /></Link>
                ...
                <div className="relative mt-4" tabIndex={-1} data-uk-slider="finite:true">
                    ...
                    {/* <!-- slide nav icons --> */}
                    <Link className="nav-prev" href="#" data-uk-slider-item="previous"> <IoChevronBack className="text-2xl" /> </Link>
                    <Link className="nav-next" href="#" data-uk-slider-item="next"> <IoChevronForward className="text-2xl" /></Link>
