                  ...
                  <div className="flex md:items-end justify-between md:mt-8 mt-4 max-md:flex-col gap-4">
                    ...
                    <div className="flex items-center gap-3 text-sm">
                      ...
                      <div>
                        ...
                        <div className="w-[240px] !bg-background-2 !p-2 !rounded-lg" data-uk-dropdown="pos: bottom-right; animation: uk-animation-scale-up uk-transform-origin-top-right; animate-out: true; mode: click;offset:10">
                          <nav className="flex flex-col items-start gap-2">
                            <Link href="#" className="flex flex-1 items-center gap-1.5 p-2 rounded-lg hover:bg-hover-1 w-full"> <IoPricetagsOutline className=" text-xl" /> Unfollow </Link>
                            <Link href="#" className="flex flex-1 items-center gap-1.5 p-2 rounded-lg hover:bg-hover-1 w-full"> <IoTimeOutline className=" text-xl" />  Mute story </Link>
                            <Link href="#" className="flex flex-1 items-center gap-1.5 p-2 rounded-lg hover:bg-hover-1 w-full"> <IoFlagOutline className=" text-xl" />  Report </Link>
                            <Link href="#" className="flex flex-1 items-center gap-1.5 p-2 rounded-lg hover:bg-hover-1 w-full"> <IoShareOutline className=" text-xl" /> Share profile </Link>
                            <hr />
                            <Link href="#" className="flex flex-1 items-center gap-1.5 p-2 rounded-lg hover:bg-hover-1 w-full text-red-400 hover:!bg-red-50 dark:hover:!bg-red-500/50"> <IoStopCircleOutline className="text-xl" />  Block </Link>
                          </nav>
                        </div>
                      </div>
                    </div>
