...
import { IoAddOutline, IoChatbubbleEllipsesOutline, IoEllipsisHorizontal, IoFlagOutline, IoLinkOutline, IoPricetagOutline, IoShareOutline, IoStopCircleOutline } from 'react-icons/io5';
      ...
      <div className="max-w-[1065px] mx-auto">
        ...
        <div className="bg-foreground-1 shadow lg:rounded-b-2xl lg:-mt-10 ">
          ...
          <div className="relative overflow-hidden w-full lg:h-72 h-36">
            <Image width={1500} height={1000} src="/images/group/group-cover-1.jpg" alt="" className="h-full w-full object-cover inset-0" />
              ...
              <div className="flex lg:items-center justify-between max-md:flex-col">
                ...
                <div className="flex-1">
                  ...
                  <p className=" font-normal text-gray-500 mt-2 flex gap-2 flex-wrap dark:text-white/80">
                    ...
                    <span> <b className="font-medium text-text-1">1.2K</b> likes </span>
                    <span className="max-lg:hidden"> • </span>
                    <span> <b className="font-medium text-text-1">1.4K</b> followers </span>
                  </p>
                </div>
                ...
                <div>
                  <div className="flex items-center gap-2 mt-1">
                    <div className="flex -space-x-4 mr-3">
                      <Image width={500} height={500} src="/images/avatars/avatar-2.jpg" alt="" className="w-10 rounded-full border-4 border-white dark:border-slate-800" />
                      <Image width={500} height={500} src="/images/avatars/avatar-3.jpg" alt="" className="w-10 rounded-full border-4 border-white dark:border-slate-800" />
                      <Image width={500} height={500} src="/images/avatars/avatar-7.jpg" alt="" className="w-10 rounded-full border-4 border-white dark:border-slate-800" />
                    ...
                    <div>
                      <button type="button" className="rounded-lg bg-foreground-2 hover:bg-hover-2 flex px-2.5 py-2">
                        <IoEllipsisHorizontal className="text-xl" />
                      </button>
                      <div className="w-[240px]" data-uk-dropdown="pos: bottom-right; animation: uk-animation-scale-up uk-transform-origin-top-right; animate-out: true; mode: click;offset:10">
                        <nav>
                          <Link href="#" className='hover:!bg-hover-1'> <IoPricetagOutline className="text-xl" /> Unfollow </Link>
                          <Link href="#" className='hover:!bg-hover-1'> <IoShareOutline className="text-xl" /> Share  </Link>
                          <Link href="#" className='hover:!bg-hover-1'> <IoLinkOutline className="text-xl" />  Copy link </Link>
                          <Link href="#" className='hover:!bg-hover-1'> <IoChatbubbleEllipsesOutline className="text-xl" />  Sort comments </Link>
                          <Link href="#" className='hover:!bg-hover-1'> <IoFlagOutline className="text-xl" />  Report group</Link>
                          <hr />
