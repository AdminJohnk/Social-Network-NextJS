...
export default function Event(props: IEventProps) {
  return (
    ...
    >
      <div
        className='newsfeed px-5 py-5'
        style={{ height: '5000px' }}
      >
        <main>
          <div className='2xl:max-w-[1220px] max-w-[1065px]'>
            ...
            >
              ...
              {/* <!-- slide nav icons --> */}
              <a className='nav-prev' href='#' data-uk-slider-item='previous'>
                <IoChevronBack className='text-2xl' />
              </a>
              <a className='nav-next' href='#' data-uk-slider-item='next'>
                <IoChevronForward className='text-2xl' />
              </a>
            </div>
