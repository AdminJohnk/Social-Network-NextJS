          ...
          >
            <div className='flex-1'>
              <div className='box overflow-hidden bg-foreground-1'>
                ...
                <div className='p-6'>
                  <h1 className='text-xl font-semiboldmt-1'>
                    How designers estimate the impact of UX?
                  </h1>
                  ...
                  <div className='space-y-2 font-normal mt-6 leading-6'>
                    <p>
                      ...
                      sed do eiusmod tempor veniam, quis nostrud exercitation
                    ...
                    <p>
                      ...
                      voluptatem accusantium inventore veritatis et quasi
                    ...
                    <p>
                      Sed ut perspiciatis unde omnis iste natus error sit
                      voluptatem accusantium inventore veritatis et quasi
                      architecto beatae vitae dicta sunt explicabo , consectetur
              ...
              <div className='box p-5 px-6 relative bg-foreground-1'>
                <h3 className='font-semiboldtext-base'>Comments</h3>
