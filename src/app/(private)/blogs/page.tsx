          ...
          <div className='flex max-lg:flex-col 2xl:gap-12 gap-10' id='js-oversized'>
            <div className='flex-1'>
              ...
              <div tabIndex={-1} uk-slider='finite:true'>
                ...
                <Link className='nav-prev !top-24' href='#' uk-slider-item='previous'>
                  <IoChevronBack />
                </Link>
                <Link className='nav-next !top-24' href='#' uk-slider-item='next'>
                  <IoChevronForward />
                </Link>
              </div>
            ...
            <div className='2xl:w-[380px] lg:w-[330px] w-full'>
              <div
                ...
                <div
                  ...
                  <Link className='nav-prev' href='#' uk-slideshow-item='previous'>
                    <IoChevronBack />
                  </Link>
                  <Link className='nav-next' href='#' uk-slideshow-item='next'>
                    <IoChevronForward />
                  </Link>
                </div>
