...
import { CommunitiesTable } from '@/components/pages/Admin/Communities/CommunitiesTable';

interface ICommunityManagementProps {}

export default function CommunityManagement({}: ICommunityManagementProps) {
      ...
      <div className='flex items-center justify-between space-y-2'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Manage communities and their contents, categories, and tags.
          </p>
        </div>
